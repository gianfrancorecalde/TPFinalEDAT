...
public class Menu {
        ...
        while (!terminar) {
            ...
            switch (resp) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    consultasEquipos(habitaciones, equipos, desafios, planoCasa, habitacionesVisitadas,
                            desafiosResueltos);
                    break;
                case 6:
                    mostrarSistema(habitaciones, desafios, equipos, planoCasa, desafiosResueltos,
    ...
    private static void escribirLog(String elem) {
        File archivo = new File("E:\\UNCO- Licenciatura en Sistemas\\2 AÑO\\Estructura de Datos\\TpFinalEDAT\\EstadoFinal.txt");
        
        try {
            if (!archivo.exists()) {
                archivo = new File("E:\\UNCO- Licenciatura en Sistemas\\2 AÑO\\Estructura de Datos\\TpFinalEDAT\\EstadoFinal.txt");
            }
    ...
    private static void cargarInicial(DiccionarioAVL habitaciones, DiccionarioAVL desafios, DiccionarioHash equipos,
            GrafoEtiq planoCasa) {
        String cadena = "", temp;
        ...
        try (
                FileReader fr = new FileReader(
                        "E:\\UNCO- Licenciatura en Sistemas\\2 AÑO\\Estructura de Datos\\TpFinalEDAT\\EstadoInicial.txt");) {
            int valor = fr.read();
            while (valor != -1) {
                if (valor == 10) {
                    valor = fr.read();
            ...
            while (tokens.hasMoreTokens()) {
                ...
                switch (contador) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        eq.setPtjeActual(Integer.parseInt(temp));
                        break;
                    case 4:
    ...
    private static void manejoABM(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, DiccionarioHash equipos,
            DiccionarioAVL desafios) {
        Scanner sc = new Scanner(System.in);
        boolean salir =false;
        while (!salir) {
        System.out.println(
    ...
    private static void habitacion(DiccionarioAVL habitaciones, GrafoEtiq planoCasa) {
        ...
        switch (resp) {
            ...
            case 2:
                ...
                if (modPlanta(habitaciones, planoCasa, cod1, planta)) {
                    System.out.println("Modificacion realizada");
                } else {
                    System.out.println("No existe la habitacion");
                }
            ...
            case 3:
                ...
                if (modM2(habitaciones, planoCasa, cod2, m2)) {
                    System.out.println("Modificacion realizada");
                } else {
                    System.out.println("No existe la habitacion");
                }
            ...
            case 4:
                ...
                if (modSalidaExterior(habitaciones, planoCasa, cod3, sldaExt)) {
                    System.out.println("Modificacion realizada");
                } else {
                    System.out.println("No existe la habitacion");
                }
            ...
            // Alta de habitacion
                ...
                if (altaHab(habitaciones, planoCasa, cod4, resp1, resp2, resp3, resp4, resp5, resp6)) {
            ...
            case 6:
                System.out.println("Ingrese clave de la habitacion");
                int cod5 = sc.nextInt();
                if (bajaHab(habitaciones, planoCasa, cod5)) {
    ...
    private static boolean modNombreHab(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int cod, String nombre) {
        ...
        if (aux != null && aux2 != null) {
            ...
            exito = true;
            escribirLog("Se modifico el nombre de la habitacion " +cod);
        }
        return exito;
    }
    ...
    private static boolean modPlanta(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int cod, int planta) {
        ...
        if (aux != null && aux2 != null) {
            ...
            exito = true;
            escribirLog("Se modifico la planta de la habitacion " +cod);
        }
        return exito;
    }
    ...
    private static boolean modM2(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int cod, int m2) {
        ...
        if (aux != null && aux2 != null) {
            ...
            aux2.setM2(m2);
            exito = true;
            escribirLog("Se modifico los metros cuadrados de la habitacion " +cod);
        }
        return exito;
    }

    private static boolean modSalidaExterior(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int cod,
            boolean sldaExt) {
        boolean exito = false;
        Habitacion aux = (Habitacion) habitaciones.obtenerDato(cod);
        Habitacion aux2 = (Habitacion) planoCasa.modificar(aux);
        if (aux != null && aux2 != null) {
            ...
            exito = true;
            escribirLog("Se modifico salidaExterior de la habitacion "+cod);
        }
        return exito;
    }
    ...
    private static boolean bajaHab(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int cod) {
        ...
        if (habitaciones.eliminar(cod)) {
            ...
            escribirLog("Se elimino habitacion "+cod);
        }
        return exito;
    }

    private static boolean altaHab(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int cod, String nombre, int planta,
            int m2, boolean sldaExt, int habDestino, int etq) {
        boolean exito = false;
        if (!habitaciones.existeClave(cod)) {
            ...
            if (destino != null) {
                ...
                exito = true;
                escribirLog("Se creo la habitacion "+cod);
            }
        }
        return exito;
    }
    ...
    private static boolean modPtjeExigido(DiccionarioHash equipos, String nombre, int ptjeExigido) {
        ...
        if (aux != null) {
            ...
            exito = true;
            escribirLog("Se modifico el ptjeExigido del equipo "+nombre);
        }
        return exito;
    }
    ...
    private static boolean modPtjeTotal(DiccionarioHash equipos, String nombre, int ptjeTotal) {
        ...
        if (aux != null) {
            ...
            exito = true;
            escribirLog("Se modifico el ptjeTotal del equipo "+nombre);
        }
        return exito;
    }
    ...
    private static boolean modPtjeAcutal(DiccionarioHash equipos, String nombre, int ptjeActual) {
        ...
        if (aux != null) {
            ...
            exito = true;
            escribirLog("Se modifico el ptje acutal del equipo "+nombre);
        }
        return exito;
    }
    ...
    private static boolean modHabitacion(DiccionarioHash equipos, String nombre, int habitacion) {
        ...
        if (aux != null) {
            ...
            exito = true;
            escribirLog("Se modifico la habitacion del equipo "+nombre);
        }
        return exito;
    }

    private static boolean altaEquipo(DiccionarioHash equipos, String nombre, int ptjeExigido) {
        escribirLog("Se creo equipo "+nombre);
    ...
    private static boolean bajaEquipo(DiccionarioHash equipos, String nombre) {
        escribirLog("Se elimino equipo "+nombre);
    ...
    private static boolean modNomDesafio(DiccionarioAVL desafios, int ptje, String nombre) {
        ...
        if (aux != null) {
            aux.setNombre(nombre);
            exito = true;
            escribirLog("Se modifico el nombre del desafio "+ptje);
        }
        return exito;
    }
    ...
    private static boolean modTipo(DiccionarioAVL desafios, int ptje, String tipo) {
        ...
        if (aux != null) {
            aux.setTipo(tipo);
            exito = true;
            escribirLog("Se modifico el tipo del desafio "+ptje);
        }
        return exito;
    }
    ...
    */
    ...
    private static void consultasHabitaciones(DiccionarioAVL habitaciones, GrafoEtiq planoCasa) {
        ...
        while (!salir) {
            ...
            switch (resp) {
                case 1:
                    System.out.println("Ingrese clave de la habitacion origen, solo numeros");
                    int cod = sc.nextInt();
                ...
                case 2:
                    System.out.println("Ingrese clave de la habitacion origen, solo numeros");
                    int cod1 = sc.nextInt();
                    System.out.println(habitacionesContiguas(cod1, habitaciones, planoCasa));
                    break;
                case 3:
                    System.out.println("Ingrese clave de la habitacion origen, solo numeros");
                    int cod2 = sc.nextInt();
                    ...
                    int ptje = sc.nextInt();
                    if (esPosibleLLegar(cod2, codHab1, ptje, habitaciones, planoCasa)) {
                ...
                case 4:
                    ...
                    System.out.println(sinPasarPor(habitaciones, planoCasa, cod3, codHab2, codHab3, ptjeLimit));
                    break;
                case 5:
                    System.out.println("Ingrese clave de la habitacion origen, solo numeros");
                    int cod4 = sc.nextInt();
                    ...
                    System.out.println(maximoPuntaje(cod4, codHab4, habitaciones, planoCasa));
                    break;
                case 6:
                    salir = true;
                    break;
    ...
    private static String mostrarHabitacion(int cod, DiccionarioAVL habitaciones) {
        ...
        if (aux != null) {
            // habitacion existe
            cadena += "Nombre de la habitacion: " + aux.getNombre() + " Planta: " + aux.getPlanta()
                    + " Metros cuadrados: " + aux.getM2() + " Tiene salida exterior: "
                    + ((aux.getSalidaExt()) ? sOk : sErr);
        }
        return cadena;
    }
        ...
        if (auxHab != null) {
            ...
            if (!lis.esVacia()) {
                while (i <= lis.longitud()) {
                    ...
                    i++;
                    cadena += "Para pasar a la habitacion: " + auxHab.getNombre() +"|"+ auxHab.getCod()
                            + " es necesario la siguiente cantidad de puntaje: " + auxPtje + "2\n";
                }
            }
        }
        return cadena;
    ...
    private static boolean esPosibleLLegar(int codHab1, int codHab2, int ptje, DiccionarioAVL habitaciones,
            GrafoEtiq planoCasa) {
        // Busca si existe camino de hab1 a hab2 con cierta cantidad de ptje, pasado por
        // paramentro. Si existe devuelve verdadero y en caso contrario falso.
    ...
    private static String sinPasarPor(DiccionarioAVL habitaciones, GrafoEtiq planoCasa, int codHab1, int codHab2,
            int codHab3, int ptjeLimite) {
        String cadena = "";
        Lista lis, aux;
        int i;
        Habitacion hab1 = (Habitacion) habitaciones.obtenerDato(codHab1);
    ...
    private static String mostrarDesafios(int ptje, DiccionarioAVL desafios) {
        ...
        if (auxDes != null) {
            cadena += "Nombre del desafio: " + auxDes.getNom() + " Tipo de desafio: " + auxDes.getTipo()
                    + " Puntaje del desafio: " + ptje;
        }
        return cadena;
    }
    ...
    private static boolean verificarDesafioResuelto(String nomEq, int ptjeDes, HashMapAbierto desafiosResueltos) {
        // Verifica si el desafio pasado por parametro esta se encuentra en hashMap de
        // desafios resueltos, devolvera verdadero si lo encunetra y falso en caso
        // contario
    ...
    private static void consultasEquipos(DiccionarioAVL habitaciones, DiccionarioHash equipos, DiccionarioAVL desafios,
            GrafoEtiq planoCasa, HashMapAbierto habitacionesVisitadas, HashMapAbierto desafiosResueltos) {
        Scanner sc = new Scanner(System.in);
        boolean salir = false;
        while (!salir) {
            System.out.println(
            ...
            switch (resp) {
                ...
                case 3:
                    ...
                    if (pasarAHabitacion(n2, c1, habitaciones, equipos, planoCasa, habitacionesVisitadas)) {
                        ...
                        System.out.println("No puede pasar de habitacion");
                    }
                    break;
                case 4:
                    System.out.println("Ingrese nombre del equipo");
                ...
                case 5:
                    ...
                    System.out.println("Ingrese clave de la habitacion");
                    int c2 = sc.nextInt();
                    System.out.println(posiblesDesafios(n4, c2, habitaciones, desafios, equipos, planoCasa));
                    break;
                case 6:
                    salir = true;
                    break;
    ...
    private static String mostrarInfoEquipo(String nombre, DiccionarioHash equipos, DiccionarioAVL habitaciones) {
        ...
        if (aux != null) {
            cadena += "Nombre del equipo: " + nombre + " Puntaje exigido: " + aux.getPtjeExigido() + " Puntaje total: "
                    + aux.getPtjeTotal() + " Puntaje actual: " + aux.getPtjeActual() + " Habitacion: "
                    + aux2.getNombre();
        }
        return cadena;
    }

    private static boolean jugarDesafio(String nombre, int ptje, DiccionarioAVL desafios, DiccionarioHash equipos,
            HashMapAbierto desafiosResueltos) {
        boolean exito = false;
    ...
    private static boolean pasarAHabitacion(String nombre, int cod, DiccionarioAVL habitaciones,
            DiccionarioHash equipos, GrafoEtiq planoCasa, HashMapAbierto habitacionesVisitadas) {
        boolean exito = false, contiguas = false;
        Lista lis;
        int i = 1;
        Equipo eq = (Equipo) equipos.obtenerInformacion(nombre);
        Habitacion habVisitada = (Habitacion) habitaciones.obtenerDato(eq.getHab());
        Habitacion hab = (Habitacion) habitaciones.obtenerDato(cod), aux;
        if (eq != null && hab != null) {
            if (eq.getHab() != cod) {
                // verifico que la habitacion en la que esta el equipo no es la misma por la
                // cual se esta preguntando
                lis = planoCasa.verticesContiguos(hab);
                while (i <= lis.longitud() && !contiguas) {
                    // Verifico si existe la habitacion en las habitaciones contiguas a la pasada
                    // por paramentro
                    aux = (Habitacion) lis.recuperar(i);
                    contiguas = aux.getCod() == eq.getHab();
                    i = i + 2;
                }
                if (contiguas && (int) planoCasa.valorDelArco(hab,
                        (Habitacion) habitaciones.obtenerDato(eq.getHab())) <= (eq.getPtjeTotal() + eq.getPtjeActual())
                        && !habitacionesVisitadas.pertenece(nombre, hab)) {
                    // la habitacion contigua existe
                    // Compruebo que el equipo pueda pasar de habitacion con el ptje total mas el
                    // actual obtenido por los desafios resueltos en la habitacion actual
                    // Verifico que la haabitacion no haya sido visitada anteriormente
                    exito = true;
                    eq.setPtjeTotal(eq.getPtjeTotal() + eq.getPtjeActual()); // ptje total que tiene el equipo + ptje
                                                                             // acumulado de los desafios resueltos en
                                                                             // la habitacion actual
                    eq.setPtjeActual(0);
                    eq.setHab(hab.getCod());
                    habitacionesVisitadas.asociar(nombre, habVisitada); // agrego habitacion anterior a la que se encuentra
                                                                // actualmente
                }
            }
        }
    ...
    private static boolean puedeSalir(String nombre, DiccionarioAVL habitaciones, DiccionarioHash equipos) {
        ...
        if (eq != null) {
            ...
            if (hab.getSalidaExt()) {
                ...
                // el ptje actual es igual o mayor al exigido o la suma del ptje total y actual
                // es igual o mayor al exigido
            }
        }
        return puedeSalir;
    }
    ...
    private static String posiblesDesafios(String nombre, int codHab, DiccionarioAVL habitaciones,DiccionarioAVL desafios, DiccionarioHash equipos, GrafoEtiq planoCasa) {
        ...
        Lista habContiguas;
        Habitacion aux;
        boolean contiguas = false;
        Equipo eq = (Equipo) equipos.obtenerInformacion(nombre);
        Habitacion habContigua = (Habitacion)habitaciones.obtenerDato(codHab);
        if (eq != null && habContigua != null) {
            int i = 1;
            if (eq.getHab() != codHab) {
                // verifico que la habitacion en la que esta el equipo no es la misma por la
                // cual se esta preguntando
                habContiguas = planoCasa.verticesContiguos(habContigua);
                while (i <= habContiguas.longitud() && !contiguas) {
                    // Verifico si existe la habitacion en las habitaciones contiguas a la pasada
                    // por paramentro
                    aux = (Habitacion) habContiguas.recuperar(i);
                    contiguas = aux.getCod() == eq.getHab();
                    i = i + 2;
                }
            }
    ...
    public static void mostrarSistema(DiccionarioAVL habitaciones, DiccionarioAVL desafios, DiccionarioHash equipos,
            GrafoEtiq planoCasa, HashMapAbierto desafiosResueltos, HashMapAbierto habitacionesVisitadas) {
        System.out.println("Grafo del Plano de Casa\n" + planoCasa.toString() + "\n");
        System.out.println("AVL de Habitaciones\n" + habitaciones.toString() + "\n");
        System.out.println("AVL de Desafios\n" + desafios.toString() + "\n");
        System.out.println("Diccionario de Equipos\n" + equipos.toString() + "\n");
        System.out.println("Mapeo de Desafios Resueltos\n" + desafiosResueltos.toString() + "\n");
        System.out.println("Mapeo de Habitaciones visitadas\n" + habitacionesVisitadas.toString() + "\n");
    }
}
